...
const ExpenseSummaryCards = ({ balance, yourExpenses, totalExpenses}) => {
  ...
  return (
    <div className="flex gap-3 p-4 w-full max-w-4xl mx-auto justify-center overflow-x-auto flex-nowrap">
      <div className="w-28 sm:w-36 md:w-40 lg:w-48 rounded-lg border border-gray-200 shadow-sm p-3 sm:p-5 bg-[#1a2030] flex-shrink-0">
        <div className="flex flex-col justify-around">
          <span className="text-green-600 font-medium mb-1 sm:mb-2 text-xs sm:text-sm">
            Total Expenses
          </span>
      ...
      <div className="w-28 sm:w-36 md:w-40 lg:w-48 rounded-lg border border-gray-200 shadow-sm p-3 sm:p-5 bg-[#1a2030] flex ">
        <div className="flex flex-col justify-around">
          <span className="text-green-600 font-medium mb-1 sm:mb-2 text-xs sm:text-sm">
            Balance
          </span>
